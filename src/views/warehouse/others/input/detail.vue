    ...
    <div class="content">
      <a-splitpanes class="default-theme" horizontal>
        ...
        <pane :size="100 - paneSize">
          <ExDetailTable
            :columns="warOthersInputOfDetailColumns"
...
<script lang="ts" setup name="warehouse-others-input-detail">
  import {
    detailOfExaGridOptions,
    warOthersInputOfDetailColumns,
  ...
  import { add, audit, unAudit, getOneById, othersInputEntity } from '/@/api/others/input';
  ...
  //输入框默认值
  const formData: othersInputEntity = {
    id: undefined,
    number: '',
    way: 'A',
