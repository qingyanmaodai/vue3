    ...
    <div class="content">
      <a-splitpanes class="default-theme" horizontal>
        ...
        <pane :size="100 - paneSize">
          <ExDetailTable
            :columns="warOthersOutputOfDetailColumns"
...
<script lang="ts" setup name="warehouse-others-output-detail">
  import {
    detailOfExaGridOptions,
    warOthersOutputOfDetailColumns,
  ...
  import { add, audit, unAudit, getOneById, othersOutputEntity } from '/@/api/others/output';
  ...
  //输入框默认值
  const formData: othersOutputEntity = {
    id: undefined,
    number: '',
    way: 'A',
