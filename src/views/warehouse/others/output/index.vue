<template>
  <div class="default-theme" style="padding: 15px; height: 100%">
    <div style="background-color: #fff; height: 100%; padding: 0 6px">
      ...
      <ExTable
        :isShowImport="false"
        :columns="warOthersOutputColumns"
...
<script setup lang="ts" name="warehouse-others-output-index">
  ...
  import {
    ...
    upSearch,
    pushDown,
  } from '/@/api/others/output';
  import 'splitpanes/dist/splitpanes.css';
  import { cloneDeep } from 'lodash-es';
  import { gridOptions, warOthersOutputColumns } from '/@/components/ExTable/data';
  ...
  const addTableEvent = () => {
    let groupId = '';
    go({
      path: PageEnum.WAR_OTHERS_OUTPUT_DETAIL,
      query: {
