...
export const warPurOrdersColumns = [
  ...
  { type: 'seq', title: '序号', width: 50 },
  { field: 'number', title: '单据编号', width: 250, slots: { default: 'number' }, sortable: true },
  { field: 'bdEmployee.name', title: '采购员', width: 120, sortable: true },
  { field: 'bdMaterial.number', title: '物料编号', width: 120, sortable: true },
  { field: 'bdMaterial.name', title: '物料名称', width: 120, sortable: true },
  { field: 'bdMaterial.model', title: '规格型号', width: 120, sortable: true },
  { field: 'bdMaterial.baseUnitName', title: '基本单位', width: 120, sortable: true },
  { field: 'bsDate', title: '业务日期', width: 120, slots: { default: 'bsDate' }, sortable: true },
  { field: 'bdSupplier.name', title: '供应商', width: 120, sortable: true },
  { field: 'countNum', title: '采购数量', width: 120, sortable: true },
  { field: 'bdStock.name', title: '仓库', width: 120, sortable: true },
  { field: 'bdStockCompartment.name', title: '分仓', width: 120, sortable: true },
  { field: 'bdStockLocation.name', title: '仓位', width: 120, sortable: true },
  { field: 'mark', title: '备注', width: 150, sortable: true },
  {
    field: 'bsStatus',
    title: '数据状态',
