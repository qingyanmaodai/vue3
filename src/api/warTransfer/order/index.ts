...
export interface transferOrderEntity extends PublicModel {
  id: string | undefined;
  number: string;
  ...
  way?: string;
  dtData?: transferOrderDetailEntity[];
  dtLk?: InvCountEntity;
  srcField?: string;
  srcBill?: string;
  srcBillId?: string;
...
export interface transferOrderDetailEntity extends PublicModel {
  id: string | undefined;
  number?: string;
  name?: string;
  seq: number;
...
export function getDataList(json: RequestData<SearchParams[]>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.GET_PAGE_TRANSFER_ORDER_LIST,
      data: json,
    },
    {
...
export function getSearchOption(json: RequestData<string>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<ControlSet[]>(
    {
      url: Url.GET_TRANSFER_ORDER_DTO,
      data: json,
    },
    {
      errorMessageMode: mode,
 ...
 * 添加信息
 */
export function add(json: RequestData<transferOrderEntity>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<transferOrderEntity>(
    {
      url: Url.ADD_WITH_DETAIL_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
 ...
 * 编辑信息
 */
export function update(json: RequestData<transferOrderEntity>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<transferOrderEntity>(
    {
      url: Url.UPDATE_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function auditBatch(json: RequestData<Array<string>>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.BATCH_AUDIT_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function pushDown(
  ...
  return defHttp.post<any>(
    {
      url: Url.PUSHDOWN_TRANSFER_ORDER + PushDownTableName,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function getOneById(json: RequestData<string>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.GET_ONE_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function delById(json: RequestData<string>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.DELETE_WITH_DETAIL_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function delBatch(json: RequestData<Array<string>>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.BATCH_DELETE_WITH_DETAIL_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function unAudit(json: RequestData<object>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<transferOrderEntity>(
    {
      url: Url.UN_AUDIT_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function unAuditBatch(json: RequestData<Array<string>>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.UN_BATCH_AUDIT_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function importFile(json: RequestData<any>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.IMPORT_MODEL_TRANSFER_ORDER,
      data: json,
      responseType: 'blob',
    },
    {
...
export function downSearch(json: RequestData<any>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.DOWN_SEARCH_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function upSearch(json: RequestData<any>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.UP_SEARCH_TRANSFER_ORDER,
      data: json,
    },
    {
      errorMessageMode: mode,
