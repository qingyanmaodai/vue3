...
export interface othersOutputEntity extends PublicModel {
  id: string | undefined;
  number: string;
  ...
  way?: string;
  dtData?: othersOutputDetailEntity[];
  dtLk?: InvCountEntity;
  srcField?: string;
  srcBill?: string;
  srcBillId?: string;
...
export function getDataList(json: RequestData<SearchParams[]>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.GET_PAGE_OTHERS_OUTPUT_LIST,
      data: json,
    },
    {
 ...
 * 添加信息
 */
export function add(json: RequestData<othersOutputEntity>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<othersOutputEntity>(
    {
      url: Url.ADD_WITH_DETAIL_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
 ...
 * 编辑信息
 */
export function update(json: RequestData<othersOutputEntity>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<othersOutputEntity>(
    {
      url: Url.UPDATE_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function auditBatch(json: RequestData<Array<string>>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.BATCH_AUDIT_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function pushDown(
  ...
  return defHttp.post<any>(
    {
      url: Url.PUSHDOWN_OTHERS_OUTPUT + PushDownTableName,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function delById(json: RequestData<string>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.DELETE_WITH_DETAIL_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function delBatch(json: RequestData<Array<string>>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.BATCH_DELETE_WITH_DETAIL_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function unAudit(json: RequestData<object>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<othersOutputEntity>(
    {
      url: Url.UN_AUDIT_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function unAuditBatch(json: RequestData<Array<string>>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.UN_BATCH_AUDIT_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function importFile(json: RequestData<any>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.IMPORT_MODEL_OTHERS_OUTPUT,
      data: json,
      responseType: 'blob',
    },
    {
...
export function downSearch(json: RequestData<any>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.DOWN_SEARCH_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
...
export function upSearch(json: RequestData<any>, mode: ErrorMessageMode = 'message') {
  return defHttp.post<Result>(
    {
      url: Url.UP_SEARCH_OTHERS_OUTPUT,
      data: json,
    },
    {
      errorMessageMode: mode,
